...
function expandHw1() { //expands homework 1 and displays the names, grades and the save changes button
    studentNamesHw1.innerHTML += '<p>Stavros Halkias<br/>Tony Soprano<br/>Saul Goodman</p>';
    hw1Grades.innerHTML += '<br/><input type="text" class="gradeNumerator" value="20">/30<br/><input type="text" class="gradeNumerator" value="20">/30<br/><input type="text" class="gradeNumerator" value="20">/30<br/>';
    hw1Grades.innerHTML += '<button type="button" class="saveChanges">Save changes </button>'
    hw1Button.removeEventListener("click", expandHw1);
    hw1Button.addEventListener("click", collapseHw1);
}

function collapseHw1() { 
    document.getElementById('hw1Grades').innerHTML = ""; //set the student names and grades to blank so the menu collapses 
    document.getElementById('studentNamesHw1').innerHTML = "";
...
function expandQ1() {
    studentNamesQ1.innerHTML += '<p>Stavros Halkias<br/>Tony Soprano<br/>Saul Goodman</p>';
    q1Grades.innerHTML += '<br/><input type="text" class="gradeNumerator" value="-">/100<br/><input type="text" class="gradeNumerator" value="-">/100<br/><input type="text" class="gradeNumerator" value="-">/100<br/>';
    q1Grades.innerHTML += '<button type="button" class="saveChanges">Save changes </button>'
    q1Button.removeEventListener("click", expandQ1);
    q1Button.addEventListener("click", collapseQ1);
}

function collapseQ1() {
    document.getElementById('q1Grades').innerHTML = "";
    document.getElementById('studentNamesQ1').innerHTML = "";
