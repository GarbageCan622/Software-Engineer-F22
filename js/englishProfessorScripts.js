...
/* Variables */ {
	...
	var letter_scale = [];
	var weights = [];
	var assignments = ['EHW1','EHW2','EP1','EFP'];
	var assignments_names = new Map();
	{
		assignments_names.set('EHW1', 'Homework 1');
		assignments_names.set('EHW2', 'Homework 2');
		assignments_names.set('EP1', 'Paper 1');
		assignments_names.set('EFP', 'Final Paper');
	}
	var assignments_cats = new Map();
	{
		assignments_cats.set('EHW1', 'Homework');
		assignments_cats.set('EHW2', 'Homework');
		assignments_cats.set('EP1', 'Paper');
		assignments_cats.set('EFP', 'Final Paper');
	}
