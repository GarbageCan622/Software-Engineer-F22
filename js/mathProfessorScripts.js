...
//expands homework 1 to display the names and grades 
function expandHw1() { 
...
/*Load from local storage*/ {
	function loadFromLocal() {	//Calls functions that must load values from local storage
		load_letter_scale();
...
/* Category functions*/ {
	function load_category_weights() {
		...
		document.getElementById('cat1').value = weights[0];	//CW
		document.getElementById('cat2').value = weights[1];	//HW
		document.getElementById('cat3').value = weights[2];	//Quiz
		document.getElementById('cat4').value = weights[3];	//Exam
	}
